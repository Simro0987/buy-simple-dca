...
export const TOKENS: TokenConfig[] = [
  ...
  { id: 'eth', symbol: 'ETH', name: 'Ethereum', allocation: 0.25, limitDiscount: 0.93, color: '#627EEA', coingeckoId: 'ethereum' },
  { id: 'sol', symbol: 'SOL', name: 'Solana', allocation: 0.11, limitDiscount: 0.90, color: '#9945FF', coingeckoId: 'solana' },
];
